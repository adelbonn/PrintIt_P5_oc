...
slides.forEach((slide, index) => {
    ...
    if (index === 0) {
        bullet.classList.add('active') //ajoute la classe pour la photo en cours
    }
    bullets.appendChild(bullet) //ajoute le bullet point dans le container
    })
